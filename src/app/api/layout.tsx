...
export const metadata = {
  title: 'Brook & Bone',
  description: 'Private nature yards for happy dogs.'
};
      ...
      <body>
        <header style={{ background: 'var(--bb-bg-surface)', borderBottom: '1px solid var(--bb-border)' }}>
          <div style={{ maxWidth: 1144, margin: '0 auto', padding: '12px 16px', display: 'flex', gap: 16, alignItems: 'center' }}>
            <img src="/emblem.svg" width={32} height={32} alt="Brook & Bone emblem" />
            <a href="/" style={{ fontFamily: 'var(--bb-font-heading)', color: 'var(--bb-brand-2)', fontWeight: 700 }}>Brook &amp; Bone</a>
        ...
        <footer style={{ maxWidth: 1144, margin: '0 auto', padding: '24px 16px', color: 'var(--bb-brand-2)' }}>
          <small>© {new Date().getFullYear()} Brook &amp; Bone</small>
        </footer>
      </body>
    </html>
  );
